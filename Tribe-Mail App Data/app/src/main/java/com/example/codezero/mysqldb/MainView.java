...
import com.example.codezero.mysqldb.SplashScreen;
...
public class MainView extends AppCompatActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.getHelp:
                        fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.main_container, new GetHelpFragment());
                        fragmentTransaction.commit();
                    ...
                    case R.id.contactUs:
                        ...
                        break;
                    case R.id.goToVR:
                        Toast.makeText(navigationView.getContext(), "Switching to VR...", Toast.LENGTH_LONG).show();
                        Intent intent = navigationView.getContext().getPackageManager().getLaunchIntentForPackage("appinventor.ai_nitinpandit_00.Arduino_bluetooth_voice_controller");
                        if (intent != null) {
                            ...
                            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            intent.setData(Uri.parse("market://details?id=appinventor.ai_nitinpandit_00.Arduino_bluetooth_voice_controller"));
                            startActivity(intent);
                        }
                        break;
                    case R.id.logout:
                        Toast.makeText(navigationView.getContext(), "Loging Out...", Toast.LENGTH_LONG).show();
                        intent = new Intent(navigationView.getContext(), SplashScreen.class);
                        startActivity(intent);
                        break;
                }
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            json_url = "http://192.168.43.213/json_get_data.php";
        }
